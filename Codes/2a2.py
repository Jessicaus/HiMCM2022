...
resid_test=resid[0:46]
resid_train=resid[46:]
...
axes[0, 0].plot(resid_train); axes[0, 0].set_title('The Genuine Series')  
plot_acf(resid_train, ax = axes[0, 1])  
